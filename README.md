...
「Learn in Text」让你在阅读英文文章的过程中学习单词：导入文章后自动分词，点击任意单词即可查看释义，右键标记生词建立个人词库，还能借助 AI 批量生成单词信息和专属练习文章。数据保存在浏览器本地，可通过 Supabase 云同步实现跨设备备份与同步。
...
- 按文章筛选单词，跳转原文
- 词库导入 / 导出 (JSON)
- Supabase 双向差异云同步（LWW 合并 + 删除传播）
- 后台自动云同步：打开应用、切回前台、定时间隔自动静默同步
