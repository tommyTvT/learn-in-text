...
export const useAuthStore = defineStore('auth', () => {
  ...
  const identity = ref(authService.readIdentity())
  ...
  /** 记录/更新身份快照（含用户名校正） */
  function persistIdentity(currentSession, name) {
    identity.value = {
   ...
   */
  function applySession(currentSession) {
  ...
  async function refreshUsernameFromProfile(userId, fallback) {
  ...
  async function syncSettingsIfOwnerMatches() {
